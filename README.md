...
Progress being made: This sketch works just fine on the Mega 2560 because that board has plenty of memory.  This sketch is very limited on boards with less memory.  Example is on UNO - only 13 devices are supported, and the closer you get to 13, the less memory is left for your own main sketch.  I am removing memory bloat and posting daily updates.
