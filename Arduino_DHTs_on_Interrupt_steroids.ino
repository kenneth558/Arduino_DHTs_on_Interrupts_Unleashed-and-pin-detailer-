...
//const PROGMEM u8 allowed_number_consecutive_read_failures = 25;//JUST A GUESS, NOT EVEN EMPIRICS TO SUPPORT THIS. Not used without auto-retry.
...
*/
        ...
        { 
            Serial.print( F( " pin being protected by it being listed in a protected pins array" ) );
        }
...
TIFR0 &= 0xFD; // to avoid an immediate interrupt occurring.  Clear this like this before expecting full first cycle
    ...
    Serial.setTimeout( 10 ); //
    while ( !Serial ); // wait for serial port to connect. Needed for Leonardo's native USB
    Serial.print( F( "Multiple DHT using Pin Change Interrupts Sketch" ) );
    Serial.print( ( char )10 );if( mswindows ) Serial.print( ( char )13 );
    Serial.print( ( char )10 );if( mswindows ) Serial.print( ( char )13 );
